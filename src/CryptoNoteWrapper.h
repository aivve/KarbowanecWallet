...
Node* createInprocessNode(const CryptoNote::Currency& currency, Logging::LoggerManager& logManager, const CryptoNote::NetNodeConfig& netNodeConfig, INodeCallback& callback);
